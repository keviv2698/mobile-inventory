...
<div class="active">
		...
		<h1><marquee behavior=scroll direction="left" scrollamount="15" welcome to the store   /marquee >  </h1>
		</div>
...
?>   
        ...
        <div class="caption">
            ...
            <center><img src="uploads/<?php echo $res['prod_pic1']; ?>" width="20%" height="50%">
            <?php else: ?>
            <center><img src="uploads/default.png" width="40%" height="50%"></center>
            <?php endif; ?>
        <div class="caption">
